...
public class SwiftToolsString{
    public init(){}
    public func reverseString(source:String)->String{
    ...
    public func left(source:String,start:Int,end:Int)->String{
    ...
    public func right(source:String,start:Int)->String{
    ...
    public func substring(source:String,start:Int,end:Int)->String{
    ...
    public func asciiCharacterValue(value:Character)->UInt8{
        return value.asciiValue!
    }
    public func consonantLetters(source:String)->[Character]{
        return source.filter{$0 == "A" || $0 == "a" || $0 == "I" || $0 == "i" || $0=="E" || $0 == "e" || $0 == "O" || $0 == "o" || $0 == "U" || $0 == "u"}
    }
    public func vowelLetters(phrase:String)->[Character]{
    ...
    public  func findString(source:String,searchString:String)->Bool{
        return [source].contains(where: { value in
            return value.contains(searchString)
        })
    }
    public func isPalindrom(s:String)->Bool{
    ...
    public func checkPhrase(source:String)->(Int,Int,Int){
        var isLetter:Int=0
        var isNumber:Int=0
        var isSpace:Int=0
